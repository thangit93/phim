...
<div id="nav2">
    <div class="container">
        <h1 class="title">Dach sách phim năm <?php the_title() ;?></h1>
    </div>
</div>
        ...
        <div class="block" id="page-list">
            ...
            <div class="blockbody">
                <ul class="list-film">
                    ...
                    query_posts('post_type=post&showposts=32&meta_key=phim_nsx&meta_value='.$qg.'&paged='.$page);
