...
*/
	...
	function wp_head() {
		...
		*/
		echo "\n<!-- All in One SEO Pack - Pro Version $this->version by Michael Torbert of Semper Fi Web Design";
...
//			$keywords =	$this->get_unique_keywords($keywords);
		...
		if (isset($description) && (strlen($description) > $this->minimum_description_length) && !(is_home() && is_paged())) {
            ...
            $meta_string .= sprintf("<meta name=\"description\" content=\"$desc %s\" />", $description);
		}
		...
		echo "<!-- /all in one seo pack Pro Version-->\n";
	}
...
/*	        if ($page && $page > 1) {
	...
	function rewrite_title($header) {
		...
		if (is_home() && !$this->is_static_posts_page()) {
			...
			$title_en = get_post_meta($post->ID, "phim_en", true)." full HD"; //Gọi title Tiếng Anh
			$title = $new_title ." - ". $title_en; // Thêm title tiếng anh vào single
			$title = trim($title);
...
//		if (!wp_verify_nonce($nonce, 'edit-aioseop-nonce')) die ( 'Security Check - If you receive this in error, log out and back in to WordPress');
	...
	function edit_category_form() {
		...
		<a href="http://www.racktheme.com/"><?php _e('All in One SEO Pack', 'all_in_one_seo_pack') ?></a>
		</th>
		</tr>
		<tr>
	...
	function add_meta_tags_textinput() {
	 ...
	 <?php if (substr($this->wp_version, 0, 3) >= '2.5') { ?>
		...
		<a target="__blank" href="http://www.racktheme.com/"><?php _e('Click here for Support', 'all_in_one_seo_pack') ?></a>
		<input value="aiosp_edit" type="hidden" name="aiosp_edit" />
...
<input type="hidden" name="nonce-aioseop-edit" value="<?php echo wp_create_nonce('edit-aioseop-nonce'); ?>" />
	...
	function admin_menu() {
		...
		add_submenu_page('options-general.php', __('All in One SEO', 'all_in_one_seo_pack'), __('All in One SEO Pro', 'all_in_one_seo_pack'), 10, $file, array($this, 'options_panel'));
	}
...
<div class="wrap">
<h2><?php _e('All in One SEO - Pro Version  Plugin Options', 'all_in_one_seo_pack'); ?></h2>
...
href="http://www.racktheme.com/"><?php _e("Changelog", 'all_in_one_seo_pack')?>
</a>
| <a target="_blank" title="<?php _e('FAQ', 'all_in_one_seo_pack') ?>"
href="http://www.racktheme.com/"><?php _e('FAQ', 'all_in_one_seo_pack') ?></a>
| <a target="_blank" title="<?php _e('All in One SEO Plugin Support Forum', 'all_in_one_seo_pack') ?>"
href="http://www.racktheme.com/"><?php _e('Support', 'all_in_one_seo_pack') ?></a>
| <a target="_blank" title="<?php _e('All in One SEO Plugin Translations', 'all_in_one_seo_pack') ?>"
href="http://www.racktheme.com/"><?php _e('Translations', 'all_in_one_seo_pack') ?></a>
<br />
...
<?php
_e("This option will automatically generate Canonical URLS for your entire WordPress installation.  This will help to prevent duplicate content penalties by <a href='http://www.racktheme.com' target='_blank'>Google</a>.", 'all_in_one_seo_pack');
 ?>
</div>
</td>
</tr>
...
<a href="http://www.racktheme.com/" title="SMS Text Message WordPress plugin">SMS Text Message</a> - sends SMS updates to your readers<br />
<a href="http://www.racktheme.com/" title="WordPress Security">WordPress Security Scan</a> - provides vital security for your WordPress site
</p>
</form>
</div>
<?php
